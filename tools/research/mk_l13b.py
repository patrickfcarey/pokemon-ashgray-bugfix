#!/usr/bin/env python3
"""Build tvtest/l13b_test.gba — same lab coord-trigger injection as d7_test.gba at (4,9)
...
scr = bytes.fromhex('16f7400200') + bytes.fromhex('390705ff04001200') + b'\x27\x02'
...
open('tvtest/l13b_test.gba', 'wb').write(ag)
print('l13b_test.gba: lab trigger (4,9) var 0x40F7==1 -> warp 5.4')
