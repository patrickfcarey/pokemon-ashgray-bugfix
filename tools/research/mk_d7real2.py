#!/usr/bin/env python3
"""Build tvtest/d7_real2.gba — same lab coord-trigger injection as d7_test.gba at (4,9)
(var 0x40F7==1), but the script WARPS to the Viridian PC (5.4 warp0) instead of running
...
scr = bytes.fromhex('16f7400200') + bytes.fromhex('3905040000000000') + b'\x27\x02'
...
open('tvtest/d7_real2.gba', 'wb').write(ag)
print('d7_real2.gba: lab trigger (4,9) var 0x40F7==1 -> warp 5.4')
