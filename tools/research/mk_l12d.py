#!/usr/bin/env python3
"""Build tvtest/l12d_test.gba — L12 stage-2-whiteout repro.

Like l12b (lab(4,9) + house(2,7) warp triggers -> 3.67 (15,45)) PLUS a battle trigger
...
hnew = struct.pack('<hhBBHHH', 2, 7, 0, 0, 0x40F5, 1, 0) + struct.pack('<I', ROM+0xC00390)
...
open('tvtest/l12d_test.gba', 'wb').write(ag)
